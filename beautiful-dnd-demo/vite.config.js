...
export default ({ command, mode }) => {
  const sjs =
    mode == "production"
      ? path.resolve(__dirname, "target/scala-3.2.1-RC1/beautifuldnddemo-opt/")
      : path.resolve(__dirname, "target/scala-3.2.1-RC1/beautifuldnddemo-fastopt/");
  ...
  return {
    root: "beautiful-dnd-demo/src/main/webapp",
    resolve: {
      alias: [
        {
          find: "@sjs",
