...
export default ({ command, mode }) => {
  const sjs =
    mode == "production"
      ? path.resolve(__dirname, "target/scala-3.8.1/pragmaticdnddemo-opt/")
      : path.resolve(__dirname, "target/scala-3.8.1/pragmaticdnddemo-fastopt/");
  ...
  return {
    root: "pragmatic-dnd-demo/src/main/webapp",
    resolve: {
      alias: [
        {
          find: "@sjs",
