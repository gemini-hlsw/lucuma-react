...
export default ({ command, mode }) => {
  const sjs =
    mode == "production"
      ? path.resolve(__dirname, "target/scala-3.2.1-RC1/primereactdemo-opt/")
      : path.resolve(__dirname, "target/scala-3.2.1-RC1/primereactdemo-fastopt/");
  ...
  return {
    root: "prime-react-demo/src/main/webapp",
    resolve: {
      alias: [
        {
          find: "@sjs",
