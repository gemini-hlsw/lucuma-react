...
export default ({ command, mode }) => {
  const sjs =
    mode == "production"
      ? path.resolve(__dirname, "target/scala-3.5.0/fontawesomedemo-opt/")
      : path.resolve(__dirname, "target/scala-3.5.0/fontawesomedemo-fastopt/");
  ...
  return {
    root: "font-awesome-demo/src/main/webapp",
    resolve: {
      alias: [
        {
          find: "@sjs",
