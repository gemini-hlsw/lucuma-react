...
export default ({ command, mode }) => {
  const sjs =
    mode == "production"
      ? path.resolve(__dirname, "target/scala-3.2.1-RC1/resizabledemo-opt/")
      : path.resolve(__dirname, "target/scala-3.2.1-RC1/resizabledemo-fastopt/");
  ...
  return {
    root: "resizable-demo/src/main/webapp",
    resolve: {
      alias: [
        {
          find: "@sjs",
