...
object ReactGridLayout {
  ...
  def props(
    ...
    p.maxRows = maxRows
    p.onLayoutChange = (x: Layout) => onLayoutChange(x).runNow()
    p.onDragStart = (layout: Layout, oldItem: LayoutItem, newItem: LayoutItem, placeholder: LayoutItem, e: MouseEvent, element: HTMLElement) =>
      onDragStart(layout, oldItem, newItem, placeholder, e, element).runNow()
    p.onDrag = (layout: Layout, oldItem: LayoutItem, newItem: LayoutItem, placeholder: LayoutItem, e: MouseEvent, element: HTMLElement) =>
      onDrag(layout, oldItem, newItem, placeholder, e, element).runNow()
    p.onDragStop = (layout: Layout, oldItem: LayoutItem, newItem: LayoutItem, placeholder: LayoutItem, e: MouseEvent, element: HTMLElement) =>
      onDragStop(layout, oldItem, newItem, placeholder, e, element).runNow()
    p.onResizeStart = (layout: Layout, oldItem: LayoutItem, newItem: LayoutItem, placeholder: LayoutItem, e: MouseEvent, element: HTMLElement) =>
      onResizeStart(layout, oldItem, newItem, placeholder, e, element).runNow()
    p.onResize = (layout: Layout, oldItem: LayoutItem, newItem: LayoutItem, placeholder: LayoutItem, e: MouseEvent, element: HTMLElement) =>
      onResize(layout, oldItem, newItem, placeholder, e, element).runNow()
    p.onResizeStop  = (layout: Layout, oldItem:LayoutItem, newItem: LayoutItem, placeholder: LayoutItem, e: MouseEvent, element: HTMLElement) =>
      onResizeStop(layout, oldItem, newItem, placeholder, e, element).runNow()
    p
  }
