...
export default ({ command, mode }) => {
  const sjs =
    mode == "production"
      ? path.resolve(__dirname, "target/scala-3.2.1-RC1/hotkeysdemo-opt/")
      : path.resolve(__dirname, "target/scala-3.2.1-RC1/hotkeysdemo-fastopt/");
  ...
  return {
    root: "hotkeys-demo/src/main/webapp",
    resolve: {
      alias: [
        {
          find: "@sjs",
