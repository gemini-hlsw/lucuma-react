...
//val highcharts   = "8.0.4"
val highcharts   = "7.2.1"
...
inThisBuild(List(
  homepage                := Some(url("https://github.com/rpiaggio/scalajs-react-highcharts")),
  ...
  scmInfo := Some(ScmInfo(url("https://github.com/rpiaggio/scalajs-react-highcharts"), "scm:git:git@github.com:rpiaggio/scalajs-react-highcharts.git")),
))
...
lazy val commonSettings = Seq(
  ...
  description             := "highcharts in scalajs-react",
  homepage                := Some(url("https://github.com/rpiaggio/scalajs-react-highcharts")),
  licenses                := Seq("BSD 3-Clause License" -> url("https://opensource.org/licenses/BSD-3-Clause")),
